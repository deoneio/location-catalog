...
async function setupSchema() {
  ...
  try {
    ...
    const locationFields = [
      ...
      { field: 'house_type', type: 'json', meta: { interface: 'tags', special: ['cast-json'] } },
      { field: 'categories', type: 'json', meta: { interface: 'tags', special: ['cast-json'] } },
      { field: 'city', type: 'string', meta: { interface: 'select-dropdown', options: { choices: [{ text: 'Jakarta', value: 'Jakarta' }, { text: 'Bandung', value: 'Bandung' }, { text: 'Bogor', value: 'Bogor' }, { text: 'Bekasi', value: 'Bekasi' }, { text: 'Depok', value: 'Depok' }, { text: 'Tangerang', value: 'Tangerang' }] } } },
